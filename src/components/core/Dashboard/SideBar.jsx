...
const SideBar = () => {
    ...
    if(profileLoading || authLoading){
        return (
            <div className='grid h-[calc(100vh-3.5rem)]
            min-w-[220px] items-center border-r-[1px] border-r-richblack-700 bg-richblack-800
            '>
...
<>
    <div className='flex flex-col h-[calc(100vh-3.5rem)] min-w-[220px] border-r-[1px] border-r-richblack-700 bg-richblack-800 py-10' >
        ...
        <div className='mx-auto mt-6 mb-6 h-[1px] w-10/12 bg-richblack-700'>
            ...
            className='px-8 py-2 text-sm font-meduim text-richblack-300'
            >
